...
- Cambiar a v0.0.7<version> en pom.xml, el que esta debajo de <artifactId>s3-backup-service</artifactId> 
- [pom.xml](../pom.xml)
...
Windows
> git flow release start v0.0.7; git flow release finish -m 'v0.0.7-liberada' 'v0.0.7' ; git push origin --all ; git push origin --tags
